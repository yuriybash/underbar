(function() {
  ...
  _.each = function(collection, iterator) {
      if(Array.isArray(collection)){
        ...
        for(var y in collection){
          iterator(collection[y], y, collection);
        }
      }
  };
  ...
  // console.log(_.reduce({a: 1, b:2, c:3}, function(a, b){
  //   return a + b;
  // }))
  //debugger;
  ...
  _.every = function(collection, iterator) {
    ...
    for(var x = 0; x < collection.length; x++){
        ...
        if(iterator == undefined){
          if(Boolean(collection[x]) == false) return false;
        }

        else if(Boolean(iterator(collection[x])) == false){
          return false;
        }
    }
    return true;
  ...
  _.some = function(collection, iterator) {
    ...
    for(var y = 0; y < collection.length; y++){
        ...
        if(iterator == undefined){
            if(Boolean(collection[y])) return true;
        }

        else if(Boolean(iterator(collection[y]))) return true
  ...
  _.memoize = function(func) {
    ...
    var previousResults= {};
      ...
      return function(){
        ...
        if(!(arguments[0] in previousResults)){
          previousResults[arguments[0]] = func.apply(this, arguments);

        }
        return previousResults[arguments[0]];
  ...
  _.shuffle = function(array) {
      ...
      for (var x = 0; x < arr2.length; x++) {
          ...
          var cur = arr2[x];
          var next = Math.floor(Math.random() * (arr2.length));
